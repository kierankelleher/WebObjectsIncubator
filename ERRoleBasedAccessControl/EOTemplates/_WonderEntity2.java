...
public static interface Keys {
	  // Attributes
	#foreach ($attribute in $entity.sortedClassAttributes)
	  public static final String ${attribute.uppercaseUnderscoreName} = ERXKeys.${attribute.uppercaseUnderscoreName}.key();
	#end
	  // Relationships
	#foreach ($relationship in $entity.sortedClassRelationships)
	  public static final String ${relationship.uppercaseUnderscoreName} = ERXKeys.${relationship.uppercaseUnderscoreName}.key();
	#end
}
...
#foreach ($attribute in $entity.sortedClassAttributes)
  ...
  public $attribute.userInfo.ERXConstantClassName ${attribute.name}() {
    Number value = (Number)storedValueForKey(${entity.prefixClassNameWithoutPackage}.Keys.${attribute.uppercaseUnderscoreName});
  ...
  public void set${attribute.capitalizedName}($attribute.userInfo.ERXConstantClassName value) {
    takeStoredValueForKey(value, ${entity.prefixClassNameWithoutPackage}.Keys.${attribute.uppercaseUnderscoreName});
  }
#else
  public $attribute.javaClassName ${attribute.name}() {
    return ($attribute.javaClassName) storedValueForKey(${entity.prefixClassNameWithoutPackage}.Keys.${attribute.uppercaseUnderscoreName});
  }
...
#foreach ($relationship in $entity.sortedClassToOneRelationships)
  ...
  public $relationship.actualDestination.classNameWithDefault ${relationship.name}() {
    return ($relationship.actualDestination.classNameWithDefault)storedValueForKey(${entity.prefixClassNameWithoutPackage}.Keys.${relationship.uppercaseUnderscoreName});
  }
  
  public void set${relationship.capitalizedName}($relationship.actualDestination.classNameWithDefault value) {
    takeStoredValueForKey(value, ${entity.prefixClassNameWithoutPackage}.Keys.${relationship.uppercaseUnderscoreName});
  }
  ...
  public void set${relationship.capitalizedName}Relationship($relationship.actualDestination.classNameWithDefault value) {
    ...
    if (er.extensions.eof.ERXGenericRecord.InverseRelationshipUpdater.updateInverseRelationships()) {
    	...
    	if (oldValue != null) {
    		removeObjectFromBothSidesOfRelationshipWithKey(oldValue, ${entity.prefixClassNameWithoutPackage}.Keys.${relationship.uppercaseUnderscoreName});
      }
    } else {
    	addObjectToBothSidesOfRelationshipWithKey(value, ${entity.prefixClassNameWithoutPackage}.Keys.${relationship.uppercaseUnderscoreName});
    }
  }
...
#foreach ($relationship in $entity.sortedClassToManyRelationships)
  ...
  public NSArray<${relationship.actualDestination.classNameWithDefault}> ${relationship.name}() {
    return (NSArray<${relationship.actualDestination.classNameWithDefault}>)storedValueForKey(${entity.prefixClassNameWithoutPackage}.Keys.${relationship.uppercaseUnderscoreName});
  }
...
#else
      EOQualifier inverseQualifier = new EOKeyValueQualifier(${relationship.actualDestination.classNameWithDefault}.Keys.${relationship.inverseRelationship.uppercaseUnderscoreName}, EOQualifier.QualifierOperatorEqual, this);
#end
  ...
  public void addTo${relationship.capitalizedName}($relationship.actualDestination.classNameWithDefault object) {
    includeObjectIntoPropertyWithKey(object, ${entity.prefixClassNameWithoutPackage}.Keys.${relationship.uppercaseUnderscoreName});
  }

  public void removeFrom${relationship.capitalizedName}($relationship.actualDestination.classNameWithDefault object) {
    excludeObjectFromPropertyWithKey(object, ${entity.prefixClassNameWithoutPackage}.Keys.${relationship.uppercaseUnderscoreName});
  }
  ...
  public void addTo${relationship.capitalizedName}Relationship($relationship.actualDestination.classNameWithDefault object) {
    ...
    if (er.extensions.eof.ERXGenericRecord.InverseRelationshipUpdater.updateInverseRelationships()) {
    	...
    	addObjectToBothSidesOfRelationshipWithKey(object, ${entity.prefixClassNameWithoutPackage}.Keys.${relationship.uppercaseUnderscoreName});
    }
  }
  ...
  public void removeFrom${relationship.capitalizedName}Relationship($relationship.actualDestination.classNameWithDefault object) {
    ...
    if (er.extensions.eof.ERXGenericRecord.InverseRelationshipUpdater.updateInverseRelationships()) {
    	...
    	removeObjectFromBothSidesOfRelationshipWithKey(object, ${entity.prefixClassNameWithoutPackage}.Keys.${relationship.uppercaseUnderscoreName});
    }
  }
  ...
  public $relationship.actualDestination.classNameWithDefault create${relationship.capitalizedName}Relationship() {
    ...
    addObjectToBothSidesOfRelationshipWithKey(eo, ${entity.prefixClassNameWithoutPackage}.Keys.${relationship.uppercaseUnderscoreName});
